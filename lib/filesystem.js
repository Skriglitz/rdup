...
class Filesystem {
    constructor(src) {
        ...
        this.compressonType = 'bzip2';
        this.compressonLevel = 9;
    }
    ...
    insertFile(p, shouldExclude, file, options, callback) {
        ...
        const handler = () => {
            ...
            if (options.compress) {
                ...
                let algo = cjs.selectAlgorithm(this.compressonType);
                let cbuf = algo.compressFile(contents, null, this.compressonLevel);
